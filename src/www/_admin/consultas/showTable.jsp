...
%><form method="post" action="index.jsp?tab=inf&acc=select">
    ...
    <input type="hidden" name="table" value="<%=sTable%>">
            ...
            for (int i=0; vFields!=null && i<vFields.size(); i++) {
                ...
                <td align="center">
	                ...
	                Ó<input type="radio" name="_condO<%=f.getName()%>" />
	        </td>
                <td align="center">
            ...
            %>
            <tr bgcolor="#FF9A00"><td colspan="6" align="right"><input type="submit" value="Enviar" class="botonClaro"/> </td></tr>
    </table>
</form><%
    }
    catch(Exception e) {
