...
<html>
<head>
<title> <%=com.emesa.gestinm.Customization.getProperty("gestinm.title")%> - Error 503</title>
...
<table width="700" align="center" class="pagError" cellpadding="3">
    <tr>
        ...
        <td>El servicio solicitado no est&aacute; disponible actualmente, por favor int&eacute;ntelo m&aacute;s adelante. Motivo: <b><%=exception%></b></td>
    </tr>
    <tr>
